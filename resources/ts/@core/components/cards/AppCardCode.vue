...
const activeCodeLanguage = computed<CodeLanguages>(() => preferredCodeLanguage.value === 'js' ? 'js' : 'ts')

const isCodeShown = ref(false)

const { copy, copied } = useClipboard({ source: computed(() => props.code[activeCodeLanguage.value]) })
...
const codeSnippet = computed(() =>
  highlighter.codeToHtml(props.code[activeCodeLanguage.value], {
    lang: 'vue',
    theme: 'dracula',
  }),
)
