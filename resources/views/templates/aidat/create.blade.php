...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4 class="mb-0">Yeni Aidat Şablonu</h4>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-2">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="apartment_ids[]" value="{{ $apt->id }}" id="apt{{ $apt->id }}" {{ in_array($apt->id, old('apartment_ids', [])) ? 'checked' : '' }}>
